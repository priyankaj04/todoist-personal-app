    ...
    >
      <TouchableOpacity onPress={navigation.goBack}>
        <View style={styles.header}>
          <Text style={{...styles.title, fontSize: 16 }}>Patient Files</Text>
        ...
        <View style={{ flex:1 }}>
          {
            ...
            >
              ...
              >
                {
                  patientDetails.patientfiles.length > 0 ?
                  patientDetails.patientfiles.map((item, i)=>{
                    return(
                      <View 
                        key={i}
                        style={{
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              {getName(pat.firstname)}'s {item.type} File
                            </Text>
                            <Text
                              style={{
                                color:'#000',
                            ...
                            >
                              {dayjs(item.dateoffile).format('DD MMM YYYY')}
                            </Text>
                          </View>
                        ...
                        <TouchableOpacity
                          ...
                          onPress={()=>{
                            navigation.navigate('PdfImageView', { 
                              title:`${getName(pat.firstname)}'s ${item.type} file`,
                              link: item.url
                            })
                          }}
                        >
